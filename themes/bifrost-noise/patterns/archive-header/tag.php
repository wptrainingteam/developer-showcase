...
$image = get_theme_file_uri('public/media/images/archive/tag.webp');

?>
<!-- wp:cover {"url":"<?= esc_url($image) ?>","id":100,"hasParallax":true,"dimRatio":80,"overlayColor":"black","isUserOverlayColor":true,"sizeSlug":"full","metadata":{"bindings":{"url":{"source":"bifrost-music/term","args":{"field":"image"}}}},"style":{"spacing":{"padding":{"right":"var:preset|spacing|0","left":"var:preset|spacing|0"}}},"layout":{"type":"constrained","contentSize":"80rem"}} -->
