...
$image = get_theme_file_uri('public/media/images/archive/genre-outlaw-country.png');

?>
<!-- wp:cover {"url":"<?= esc_url($image) ?>","id":173,"hasParallax":true,"dimRatio":80,"overlayColor":"black","isUserOverlayColor":true,"sizeSlug":"full","style":{"spacing":{"padding":{"right":"var:preset|spacing|0","left":"var:preset|spacing|0"}}},"layout":{"type":"constrained","contentSize":"80rem"}} -->
