...
$image = get_theme_file_uri('public/media/images/archive/genre-synth-pop.png');

?>
<!-- wp:cover {"url":"<?= esc_url($image) ?>","id":95,"hasParallax":true,"dimRatio":80,"overlayColor":"black","isUserOverlayColor":true,"sizeSlug":"full","style":{"spacing":{"padding":{"right":"var:preset|spacing|0","left":"var:preset|spacing|0"}}},"layout":{"type":"constrained","contentSize":"80rem"}} -->
