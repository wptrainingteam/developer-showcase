...
?>
<!-- wp:group {"tagName":"main","metadata":{"name":"Post Content","patternName":"bifrost-noise/content-post"},"className":"is-style-site-content","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
<main class="wp-block-group is-style-site-content"><!-- wp:group {"tagName":"article","metadata":{"name":"Post"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"default"}} -->
	<article class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:group {"tagName":"header","metadata":{"name":"Post Header"},"style":{"spacing":{"blockGap":"var:preset|spacing|70"}},"layout":{"type":"constrained"}} -->
		<header class="wp-block-group"><!-- wp:post-title {"level":1,"align":"wide","className":"is-style-text-headline"} /-->

			<!-- wp:group {"metadata":{"name":"Post Byline","patternName":"bifrost-noise/post-byline-default"},"align":"wide","className":"is-style-meta","style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","flexWrap":"wrap"}} -->
			<div class="wp-block-group alignwide is-style-meta"><!-- wp:group {"metadata":{"name":"Post Author"},"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
			...
			<!-- wp:post-featured-image {"aspectRatio":"2/1","align":"wide"} /--></header>
		<!-- /wp:group -->

		<!-- wp:group {"layout":{"type":"constrained"}} -->
		<div class="wp-block-group"><!-- wp:columns {"align":"wide"} -->
			<div class="wp-block-columns alignwide"><!-- wp:columns {"verticalAlignment":"top","align":"wide","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|100"}}}} -->
				<div class="wp-block-columns alignwide are-vertically-aligned-top"><!-- wp:column {"verticalAlignment":"top","width":"40rem","layout":{"type":"constrained","justifyContent":"left"}} -->
					<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:40rem"><!-- wp:post-content {"className":"is-style-prose","style":{"layout":{"selfStretch":"fixed","flexSize":"40rem"}},"layout":{"type":"constrained"}} /-->

						<!-- wp:group {"tagName":"footer","metadata":{"name":"Post Meta","patternName":"bifrost-noise/post-meta-default"},"className":"is-style-meta","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
						<footer class="wp-block-group is-style-meta"><!-- wp:post-terms {"term":"category","className":"is-style-icon"} /-->

							<!-- wp:post-terms {"term":"post_tag","className":"is-style-icon"} /--></footer>
						<!-- /wp:group --></div>
					<!-- /wp:column -->
					...
					<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:18.34rem"><!-- wp:group {"style":{"layout":{"selfStretch":"fit","flexSize":null}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
						<div class="wp-block-group"><!-- wp:group {"className":"is-style-section-3","style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical"}} -->
							<div class="wp-block-group is-style-section-3"><!-- wp:heading {"level":3,"className":"is-style-text-widget-heading"} -->
								<h3 class="wp-block-heading is-style-text-widget-heading">Trending Now</h3>
								<!-- /wp:heading -->
								...
								<div class="wp-block-query is-style-query-numbered"><!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"default"}} -->
									...
									<div class="wp-block-group"><!-- wp:post-title {"level":3,"isLink":true} /-->
										...
										<div class="wp-block-group is-style-meta has-3-xs-font-size"><!-- wp:post-terms {"term":"category"} /-->
